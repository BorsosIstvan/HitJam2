...
try {
    ...
    // 🔥 Vang een willekeurig nummer op uit de database
    ...
    if ($song) {
        ...
        echo json_encode(['status' => 'error', 'message' => 'Fout: Geen liedjes gevonden in game_songs. Voer eerst import_hitjam.php uit!']);
    }
} catch (Exception $e) {
